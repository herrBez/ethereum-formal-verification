...
\mode<presentation>
{
  \usepackage{YAUBT/beamerthemepadua}       % or try default, Darmstadt, Warsaw, ...
...
\input{./res/overview-verification}



\input{./res/theorem-provers.tex}

\input{./res/making-smart-contract-smarter.tex}

\input{./res/ETHIR}


\input{./res/semantic-framework-for-the-security-analysis}




\input{./res/transpiler}
...
\input{./res/concurrent-perspective-on-smart-contracts}

\input{./res/open-challenges}
