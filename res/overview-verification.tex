...
%~ \begin{frame}{Object of Verification}
    ...
    %~ \begin{block}{EVM}
        %~ \begin{itemize}
            %~ \pro Stored on the blockchain
            %~ \pro Gas consumption is defined only for bytecode
            %~ \con Developers do not usually deal with bytecode
        %~ \end{itemize}
    %~ \end{block}
    ...
    %~ \begin{block}{Solidity/High Level Languages}
        %~ \begin{itemize}
